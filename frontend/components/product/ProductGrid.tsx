        ...
        return (
          ...
          >
            <div className="relative aspect-square overflow-hidden">
              ...
              {product.badge && (
                <span className="pointer-events-none absolute left-4 top-4 z-10 rounded-full bg-terracotta-500 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-cream shadow-glow">
                  {product.badge}
                </span>
              )}
              ...
              <button
                ...
                className="absolute right-4 top-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-charcoal-800 opacity-0 shadow-soft backdrop-blur transition-all duration-300 group-hover:opacity-100 hover:bg-terracotta-500 hover:text-cream"
              >
            ...
            <Link href={href} className="flex flex-1 flex-col p-6">
              ...
              <span className="mt-5 inline-flex w-full items-center justify-center rounded-full border border-charcoal-800/15 px-4 py-2 text-sm font-medium text-charcoal-800 transition-colors duration-300 group-hover:border-terracotta-500 group-hover:text-terracotta-600">
                View Product
              </span>
            </Link>
          </motion.div>
